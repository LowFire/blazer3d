...
Draw::Draw() : m_origin(glm::vec3(0)), m_vert_count(0), position(glm::vec3(0)), 
...
void Draw::setBuffer(const std::shared_ptr<Buffer> buffer)
{
...
void Draw::setVertexArray(const std::shared_ptr<VertexArray> arrays)
{
...
std::shared_ptr<Shader> Draw::getShader()
{
	return m_shader;
}